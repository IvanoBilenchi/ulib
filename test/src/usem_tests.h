...
#if ULIB_CONCURRENCY
#define USEM_TESTS                                                                                 \
    usem_test_base, usem_test_wait_post, usem_test_partial_post, usem_test_mutex, usem_test_poll,  \
        usem_test_timeout, usem_test_timed_wait, usem_test_timed_contention
#else
