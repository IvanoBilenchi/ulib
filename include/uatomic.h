...
#define UATOMIC_BOOL_LOCK_FREE UATOMIC_LOCK_FREE_ALWAYS
#define UATOMIC_CHAR_LOCK_FREE UATOMIC_LOCK_FREE_ALWAYS
#define UATOMIC_CHAR16_T_LOCK_FREE UATOMIC_LOCK_FREE_ALWAYS
#define UATOMIC_CHAR32_T_LOCK_FREE UATOMIC_LOCK_FREE_ALWAYS
#define UATOMIC_WCHAR_T_LOCK_FREE UATOMIC_LOCK_FREE_ALWAYS
#define UATOMIC_SHORT_LOCK_FREE UATOMIC_LOCK_FREE_ALWAYS
#define UATOMIC_INT_LOCK_FREE UATOMIC_LOCK_FREE_ALWAYS
#define UATOMIC_LONG_LOCK_FREE UATOMIC_LOCK_FREE_ALWAYS
#define UATOMIC_LLONG_LOCK_FREE UATOMIC_LOCK_FREE_ALWAYS
#define UATOMIC_POINTER_LOCK_FREE UATOMIC_LOCK_FREE_ALWAYS
...
#else
    #define P_UATOMIC_CHAR_IS_LOCK_FREE (UATOMIC_CHAR_LOCK_FREE == UATOMIC_LOCK_FREE_ALWAYS)
...
#else
    typedef uint32_t p_uatomic_byte;
#endif
 ...
 */
#define uatomic_wait_ex(obj, expected, order)                                                      \
 ...
 */
#define uatomic_wait_for(obj, expected, timeout)                                                   \
 ...
 *                                     UMemoryOrder order);
 */
#define uatomic_wait_for_ex(obj, expected, timeout, order)                                         \
 ...
 */
#define uatomic_wait_until(obj, expected, deadline)                                                \
    uatomic_wait_until_ex(obj, expected, deadline, UMO_SEQ_CST)
 ...
 *       and @val{ULIB_ERR_TIMEOUT} otherwise, since no other thread could ever change it.
 *
 * @alias ulib_ret uatomic_wait_until_ex(UAtomic(T) *obj, T expected, UDeadline deadline,
 *                                       UMemoryOrder order);
 */
#define uatomic_wait_until_ex(obj, expected, deadline, order)                                      \
    p_uatomic_wait(p_uatomic_addr(obj), (uint64_t)(expected), sizeof(*(obj)), deadline, order)

/**
 * Wakes up one thread waiting on an atomic object.
 *
 * @param obj The atomic object.
 *
 * @note If concurrency is disabled, this function does nothing.
 *
 * @alias void uatomic_notify_one(UAtomic(T) *obj);
 */
#define uatomic_notify_one(obj) p_uatomic_notify_one(p_uatomic_addr(obj))

/**
 * Wakes up all threads waiting on an atomic object.
 *
 * @param obj The atomic object.
 *
 * @note If concurrency is disabled, this function does nothing.
 *
 * @alias void uatomic_notify_all(UAtomic(T) *obj);
 */
#define uatomic_notify_all(obj) p_uatomic_notify_all(p_uatomic_addr(obj))
